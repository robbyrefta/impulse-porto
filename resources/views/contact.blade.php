...
<div class="container">
	...
	<div class="card">
	  <div class="card-body text-center">
	  	<img src="img/contact/q.jpg" class="img-fluid mt-3 mb-4" style="width:30rem">
	...
	<div class="row mt-5 mb-5">
		<div class="col-4">
			...
			<div class="row">
				<div class="col-sm-2">
					<span><img src="img/contact/c1.png" style="width:3rem"></span>
				</div>
				<div class="col">
			...
			<div class="row">
				<div class="col-sm-2">
					<span><img src="img/contact/a1.png" style="width:3rem"></span>
				</div>
				<div class="col">
			...
			<div class="row">
				<div class="col-sm-2">
					<span><img src="img/contact/b1.png" style="width:3rem"></span>
				</div>
				<div class="col">
		...
		<div class="col-8">
			<form>
			  ...
			  <div class="mb-3">
			    <input type="email" class="form-control" id="exampleInput" placeholder="Your Email">
			  </div>
			  <div class="mb-3">
