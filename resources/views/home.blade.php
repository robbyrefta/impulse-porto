...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
  ...
  <div class="carousel-inner carousel-fade" data-bs-ride="carousel">
    <div class="carousel-item active">
      <img src="img/home/d.jpg" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="img/home/e.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block rounded" style="background-color: rgb(0, 0, 0, 0.3);">
    ...
    <div class="carousel-item">
      <img src="img/home/f.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block rounded" style="background-color: rgb(0, 0, 0, 0.3);">
...
<div>
	<img src="img/home/impulsex.png" class="img-fluid rounded mx-auto d-block mt-5 mb-5">
</div>
<div class="container">
	<hr>
	...
	<div class="row mb-5">
		<div class="card-group">
		  <div class="card text-center">
		    <img src="img/home/a.png" class="rounded mx-auto d-block card-img-top mt-5" style="width: 5rem;" alt="...">
		    <div class="card-body">
		  ...
		  <div class="card text-center">
		    <img src="img/home/b.png" class="rounded mx-auto d-block card-img-top mt-5" style="width: 5rem;" alt="...">
		    <div class="card-body">
		  ...
		  <div class="card text-center">
		    <img src="img/home/c.png" class="rounded mx-auto d-block card-img-top mt-5" style="width: 5rem;" alt="...">
		    <div class="card-body">
	...
	<div class="row">
		<figure class="text-center">
			<img src="img/home/g.jpg" class="img-fluid">
