	...
	<div class="container-fluid bg-dark">
		    ...
		    <div class="row">
		    	...
		    	<div class="col-sm-4">
		    		...
		    		<ul>
			    		...
			    		<li class="mb-2"><a href="/product" class="text-decoration-none">Product</a><br></li>
			    		<li class="mb-2"><a href="/about" class="text-decoration-none">About</a><br></li>
			    		<li class="mb-2"><a href="/contact" class="text-decoration-none">Contact</a><br></li>
		    		</ul>
		    	</div>
		    	<div class="col-sm-4">
		    		<h5>Our Services</h5>
	  ...
	  <div class="row">
	  	<div class="col-sm-12 justify-content-center mb-3 mt-3" style="color: ghostwhite;">
	  		<small>&copy; Copyright <b><a class="text-decoration-none" href="https://instagram.com/robbyrefta" target="_blank">Robby Refta</a></b>. All Rights Reserved</small>
	  	</div>
	  </div>
	</div>
</body>
